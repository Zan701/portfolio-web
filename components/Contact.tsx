      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          ...
          <div className="bg-surface/50 p-6 sm:p-7 rounded-2xl border border-line shadow-xl backdrop-blur-sm">
            ...
            <form action="mailto:ianku93@gmail.com" method="post" encType="text/plain" className="space-y-4">
              <div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4">
              {/* WhatsApp Button */}
              {/* Ganti nomor 628xxxxxxxxxx dengan nomor WA kamu */}
              <a 
